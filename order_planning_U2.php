...
/** Заголовок страницы */
echo "Режим <mark>простого</mark> планирования заявки:";
...
echo "<table id='main_table' border='1' style='font-size: 13px'>
        <tr>
            ...
            <th style=' border: 1px solid black'> В плане
            </th>  
            <th style=' border: 1px solid black'> Не в плане
            </th>                                                          
        </tr>";
...
echo "<br><form action='show_order.php' method='post'>"
    ...
    ."<input type='submit' value='Выход из режима простого планирования'>"
    ."</form>";
?>
