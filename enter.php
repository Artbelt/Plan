...
echo "<tr align='center'><td>"
    ...
    ."<tr height='80%'><td>Операции: <p>"
        ...
        ." Заявки другим подразделениям: <p>"
        ."<form action='small_box_order.php' method='post'><input type='submit' value='Заказ упаковки индивидуальной'  style=\"height: 20px; width: 220px\"></form>"
        ."<form action='big_box_order.php' method='post'><input type='submit' value='Заказ упаковки групповой'  style=\"height: 20px; width: 220px\"></form>"
    ."</td></tr>"
